...
starting_point=28065
#import antiSMASH DB CSV
filename_csv="/home/friederike/Documents/Coding/TailEnzA_main/TailEnzA/Classifiers/Training_data/Dataset/antismash_db_all_nrps.csv"
output_folder="/home/friederike/Documents/Coding/TailEnzA_main/TailEnzA/Classifiers/Training_data/Dataset/NRPS_genbank_files_antismash_DB/"
input_data=pd.read_csv(filename_csv)
Entrez.email = "friederike@biermann-erfurt.de"
allow_hybrids=False
output_fasta=output_folder+"nrps.fasta"
...
def obtain_partial_Genbank(NCBI_accession,genome, begin_cluster, end_cluster):
    ...
    for index in range(0, len(genome['GBSeq_feature-table'])+1):
        ...
        if genome['GBSeq_feature-table'][index]["GBFeature_key"]!="source":
            ...
            if int(genome['GBSeq_feature-table'][index]['GBFeature_intervals'][0]['GBInterval_from'])>=end_cluster or int(genome['GBSeq_feature-table'][index]['GBFeature_intervals'][0]['GBInterval_to'])>=end_cluster:
              index_protein_end=index-4
              print (end_cluster,genome['GBSeq_feature-table'][index]['GBFeature_intervals'][0]['GBInterval_from'],genome['GBSeq_feature-table'][index]['GBFeature_intervals'][0]['GBInterval_to'])
              break
